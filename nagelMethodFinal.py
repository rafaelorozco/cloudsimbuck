...
#
#
#nov 12 trying to optimize the last thing 
...
def iterateForwardVector():
	...
	act[2:row-2, 2:col-2, 2:lay-2] = (~ actCopy[2:row-2, 2:col-2, 2:lay-2]) & humCopy[2:row-2, 2:col-2, 2:lay-2] & \
		...
		# functools.reduce(np.logical_or, (   matR1[2:row-2, 2:col-2, 2:lay-2] , \
		# 									matR2[2:row-2, 2:col-2, 2:lay-2] ,
		# 									matR3[2:row-2, 2:col-2, 2:lay-2] ,
		# 									matR4[2:row-2, 2:col-2, 2:lay-2] ,
		# 									matR5[2:row-2, 2:col-2, 2:lay-2] ,
		# 									matR6[2:row-2, 2:col-2, 2:lay-2] ,
		# 									matR7[2:row-2, 2:col-2, 2:lay-2] ,
		# 									matR8[2:row-2, 2:col-2, 2:lay-2] ,
		# 									matR9[2:row-2, 2:col-2, 2:lay-2] ,
		# 									matR10[2:row-2, 2:col-2, 2:lay-2] ,
		# 									matR11[2:row-2, 2:col-2, 2:lay-2]))
